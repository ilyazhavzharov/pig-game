...
const btnRest = document.querySelector('.btn--new');

let scors, currentScore, activePlayer, playing;

// Staarting conditions
const init = function () {
  scors = [0, 0];
  currentScore = 0;
  activePlayer = 0;
...
btnRest.addEventListener('click', init);
